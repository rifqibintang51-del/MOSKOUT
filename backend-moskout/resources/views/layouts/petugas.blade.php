...
<head>
    ...
    <title>@yield('title') - MOSKOUT Petugas Panel</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        /* Sidebar Styling - Teal theme for Petugas */
        .sidebar {
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <span class="sidebar-role-badge">Petugas</span>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="{{ str_starts_with(Route::currentRouteName(), 'petugas.pemeriksaan-risiko') ? 'active' : '' }}">
                <a href="{{ route('petugas.pemeriksaan-risiko.index') }}">
                    <i class="bi bi-clipboard2-check-fill"></i>
                    <span>Pemeriksaan Risiko</span>
                </a>
            </li>
    ...
    <div class="main-content">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="dropdown">
                    <button class="btn btn-link text-decoration-none dropdown-toggle text-dark fw-bold d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                        <div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 36px; height: 36px; background-color: var(--primary-color); color: white;">
                            {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                        </div>
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                        <li><h6 class="dropdown-header">Petugas Lapangan</h6></li>
        ...
        <footer class="footer text-center">
            <p class="mb-0">&copy; {{ date('Y') }} MOSKOUT - Pemantauan Risiko DBD Terintegrasi. All rights reserved.</p>
        </footer>
    </div>
